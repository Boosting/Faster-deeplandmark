...
if __name__ == '__main__':
    ...
    model_file = '/home/vision/xc/py-faster-rcnn/models/VGG16/faster_rcnn_alt_opt/faster_rcnn_test.pt'   

    model_def_file = '/home/vision/xc/py-faster-rcnn/output/default/trainval/vgg16/VGG16_faster_rcnn_final.caffemodel'

    imgPath = '/home/vision/xc/py-faster-rcnn/data/test/ETH_test/seq03.txt' ############

    imgSavePath = '/home/vision/xc/py-faster-rcnn/output/ETH_out_images/3/' ############

    txtSavePath = "/home/vision/xc/py-faster-rcnn/output/ETH_V003.txt" ##############
