...
TXT = '/home/vision/xc/py-faster-rcnn/data/test/Face_test/lfpw_test_249_bbox.txt'
...
##################################
    ...
    OUTPUT = '/home/vision/xc/py-faster-rcnn/data/test/Face_test/out_{0}'.format(level)
    createDir(OUTPUT)
    ...
    for line1 in split_line:      
        ...
        cv2.imwrite(os.path.join(OUTPUT, os.path.basename(image_name)), img)
