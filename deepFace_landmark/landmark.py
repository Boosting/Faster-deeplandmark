...
def drawLandmark(img, bbox, landmark):
    cv2.rectangle(img, (bbox.left, bbox.top), (bbox.right, bbox.bottom), (0,0,255), 3)
    for x, y in landmark:
...
if __name__ == '__main__':
    ...
    for line in split_line:          
       src = '/home/vision/xc/fast-rcnn/data/INRIA_test/test/'+line + '.png' 
       dst = '/home/vision/xc/deep-landmark-master/xc_test/dst/%d'%num + '.jpg'
